...
from task_nicely_core.assets.task_definitions.gcp import bq_table_to_gcs, gcs_file_to_bq
...
def test_gcs_file_to_bq(mock_bigquery, mock_job, mock_table):
    ...
    # Act
    result = gcs_file_to_bq(
        source_file_uri, destination_table_id, job_config_params, mock_bigquery
    )
...
def test_bq_table_to_gcs(mock_bigquery, mock_job, mock_table):
    ...
    # Act
    result = bq_table_to_gcs(
        source_table_id, destination_file_uri, job_config_params, mock_bigquery
    )
